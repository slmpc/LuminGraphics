...
public record RotatedTexture(String textureId, UiRect bounds, float u0, float v0, float u1, float v1, LuminColor color,
                             float originX, float originY, float rotationDegrees) implements UiNode {
    public RotatedTexture {
        ...
        UiNodes.finite(originX, originY, rotationDegrees);
