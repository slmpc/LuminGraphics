...
public record Triangle(float centerX, float centerY, float size, float progress, LuminColor color) implements UiNode {
    public Triangle {
        UiNodes.require(color);
        UiNodes.finite(centerX, centerY);
        UiNodes.nonNegative(size);
