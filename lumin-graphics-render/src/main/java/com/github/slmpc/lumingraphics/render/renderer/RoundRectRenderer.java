...
public final class RoundRectRenderer extends AbstractRenderer<Render2DCommand.RoundRect> {
    public RoundRectRenderer(RenderResources r, int c) {
        super(Render2DCommand.RoundRect.class, r, c, "round-rectangle");
    }

    @Override
    protected VertexBatch vertices(Render2DCommand.RoundRect c) {
