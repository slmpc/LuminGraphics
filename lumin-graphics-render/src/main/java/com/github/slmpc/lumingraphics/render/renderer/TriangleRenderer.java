...
public final class TriangleRenderer extends AbstractRenderer<Render2DCommand.Triangle> {
    public TriangleRenderer(RenderResources r, int c) {
        super(Render2DCommand.Triangle.class, r, c, "triangle");
    }

    @Override
    protected VertexBatch vertices(Render2DCommand.Triangle c) {
