...
public sealed interface FullscreenEffectPass permits FullscreenEffectPass.External, FullscreenEffectPass.Rendering {
    ...
    final class External implements FullscreenEffectPass {
        ...
        private External() { }
        @Override public void begin(RhiCommandBuffer commands) { Objects.requireNonNull(commands, "commands"); }
        @Override public void end(RhiCommandBuffer commands) { Objects.requireNonNull(commands, "commands"); }
    }

    record Rendering(RhiRenderingInfo renderingInfo) implements FullscreenEffectPass {
        public Rendering { Objects.requireNonNull(renderingInfo, "renderingInfo"); }
        @Override public void begin(RhiCommandBuffer commands) {
            Objects.requireNonNull(commands, "commands").beginRendering(renderingInfo);
        }
        @Override public void end(RhiCommandBuffer commands) {
