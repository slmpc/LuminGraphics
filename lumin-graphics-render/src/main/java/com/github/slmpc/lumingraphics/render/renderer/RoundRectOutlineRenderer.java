...
public final class RoundRectOutlineRenderer extends AbstractRenderer<Render2DCommand.RoundRectOutline> {
    public RoundRectOutlineRenderer(RenderResources r, int c) {
        super(Render2DCommand.RoundRectOutline.class, r, c, "round-rectangle-outline");
    }

    @Override
    protected VertexBatch vertices(Render2DCommand.RoundRectOutline c) {
