...
// Voxel Landscape. Created by Reinder Nijhoff 2013
// Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License.
// @reindernijhoff
//
// https://www.shadertoy.com/view/MdlGz4
//
// port of the original JavaScript demo: http://jsfiddle.net/uzMPU/
...
vec3 renderVoxelLandscape(vec2 uv) {
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    fragColor = vec4(renderVoxelLandscape(uv), 1.0);
}
